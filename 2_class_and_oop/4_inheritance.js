...
console.log(yuJin instanceof IdolModel); // 상속받은 상위 클래스의 인스턴스는 될 수 있다.
console.log(yuJin instanceof FemaleIdolModel);
console.log(yuJin instanceof MaleIdolModel);

console.log("----------");
console.log(jiMin instanceof IdolModel); // 상속받은 상위 클래스의 인스턴스는 될 수 있다.
console.log(jiMin instanceof FemaleIdolModel);
console.log(jiMin instanceof MaleIdolModel);

console.log("----------");
console.log(cf instanceof IdolModel); // 상속받은 상위 클래스의 인스턴스는 될 수 있다.
